...
namespace AtlasTracker.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Notifications.Include(n => n.NotificationType).Include(n => n.Recipient).Include(n => n.Sender).Include(n => n.Ticket);
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,Title,Message,Created,RecipientId,SenderId,Viewed,NotificationTypeId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,Title,Message,Created,RecipientId,SenderId,Viewed,NotificationTypeId")] Notification notification)
        {
